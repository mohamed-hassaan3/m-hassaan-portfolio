...
const Chatbot = () => {
  ...
  const haveChat = messages.length ? true : false;
  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-50 rounded-full bg-neutral-500 dark:bg-neutral-800  text-white shadow-lg hover:scale-105 transition-transform p-4"
      >
