...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[20rem] w-full items-center justify-center bg-white dark:bg-black rounded-4xl",
        containerClassName
      )}
    ...
    >
      ...
      />
      <div
        className="pointer-events-none absolute inset-0 hidden dark:block rounded-4xl"
        style={{
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block bg-gradient-to-r from-indigo-300 to-purple-300 px-1 pb-1 dark:from-indigo-500 dark:to-purple-500 sm:whitespace-nowrap rounded-[6px]`,
        className
      )}
    >
      {children}
