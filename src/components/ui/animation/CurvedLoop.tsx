...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  return (
    ...
    >
      <svg
        className="select-none w-full overflow-visible block aspect-[100/8] text-[3rem] font-bold tracking-[5px] uppercase leading-none"
      ...
      >
        ...
        {ready && (
          <text
            xmlSpace="preserve"
            className={`dark:fill-neutral-800 fill-neutral-400 ${
              className ?? ""
            }`}
          >
