...
export const LoaderBounce = () => {
  return (
    <span className="flex space-x-1 m-2">
      <div
        className="w-[10px] h-[10px] bg-neutral-600 rounded-full animate-bounce"
      ...
      ></div>
      <div className="w-[10px] h-[10px] bg-neutral-600 rounded-full animate-bounce"></div>
    </span>
  );
};
